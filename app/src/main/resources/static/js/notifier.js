...
(function ($) {
    var pub = {
         ...
         *
         * Ex: notifier.notify("Your item has been successfully saved");
         * Ex: notifier.notify("Your script cannot be saved. Please retry later.", {mode: "error"})
         * Ex: notifier.notify("Does it stink?", {closeTime: 0, actions: [
         ...
         *
         * Example of use: 
         *   notifier.modalBackdrop.show();
         *   notifier.modalBackdrop.hide();
         *   notifier.modalBackdrop.css({opacity: 0.5});
         *   notifier.modalBackdrop.css({"background-color" : "#ff0"});
         */
